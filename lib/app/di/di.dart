...
import 'package:college_community_main/core/network/api_service.dart';
import 'package:college_community_main/core/network/hive_service.dart';
import 'package:college_community_main/features/auth/data/data_source/local_data_source/auth_local_datasource.dart';
import 'package:college_community_main/features/auth/data/data_source/remote_data_source/auth_remote_datasource.dart';
import 'package:college_community_main/features/auth/data/repository/auth_local_repository/auth_local_repository.dart';
import 'package:college_community_main/features/auth/data/repository/auth_remote_repository/auth_remote_repository.dart';
import 'package:college_community_main/features/auth/domain/use_case/login_usecase.dart';
import 'package:college_community_main/features/auth/domain/use_case/register_user_usecase.dart';
import 'package:college_community_main/features/auth/domain/use_case/upload_image_usecase.dart';
import 'package:college_community_main/features/auth/presentation/view_model/login/login_bloc.dart';
import 'package:college_community_main/features/auth/presentation/view_model/signup/register_bloc.dart';
import 'package:college_community_main/features/batch/data/data_source/local_datasource/batch_local_data_source.dart';
import 'package:college_community_main/features/batch/data/data_source/remote_datasource/batch_remote_datasource.dart';
import 'package:college_community_main/features/batch/data/repository/batch_local_repository.dart';
import 'package:college_community_main/features/batch/data/repository/batch_remote_repository.dart';
import 'package:college_community_main/features/batch/domain/use_case/create_batch_usecase.dart';
...
import 'package:college_community_main/features/batch/presentation/view_model/batch_bloc.dart';
import 'package:college_community_main/features/course/data/data_source/local_datasource/course_local_data_source.dart';
import 'package:college_community_main/features/course/data/data_source/remote_datasource/course_remote_datasource.dart';
import 'package:college_community_main/features/course/data/repository/course_local_repository.dart';
import 'package:college_community_main/features/course/data/repository/course_remote_repository.dart';
import 'package:college_community_main/features/course/domain/use_case/create_course_usecase.dart';
import 'package:college_community_main/features/course/domain/use_case/delete_course_usecase.dart';
import 'package:college_community_main/features/course/domain/use_case/get_all_course_usecase.dart';
import 'package:college_community_main/features/course/presentation/view_model/course_bloc.dart';
