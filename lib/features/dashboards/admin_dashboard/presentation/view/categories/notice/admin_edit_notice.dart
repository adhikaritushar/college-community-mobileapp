...
class AdminEditNotice extends StatefulWidget {
  ...
  @override
  State<AdminEditNotice> createState() => _AdminEditNoticeState();
}

class _AdminEditNoticeState extends State<AdminEditNotice> {
