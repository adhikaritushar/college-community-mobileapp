...
import 'package:college_community/features/dashboards/admin_dashboard/presentation/view/categories/profile/admin_change_password.dart';
            ...
            return Column(
              ...
              children: [
                ...
                KElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const AdminChangePassword()));
                  },
                ),
              ],
            );
