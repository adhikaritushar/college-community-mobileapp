...
class FacultyAddNotice extends StatefulWidget {
  const FacultyAddNotice({
    super.key,
  });

  @override
  State<FacultyAddNotice> createState() => _FacultyAddNoticeState();
}

class _FacultyAddNoticeState extends State<FacultyAddNotice> {
