...
class AdminChangePasswordUsecase extends UseCase<String, LoginParams> {
  final AuthRepository repository;

  AdminChangePasswordUsecase({required this.repository});
  @override
  Future<Either<AppErrorHandler, String>> call(LoginParams parms) async {
    return repository.adminChangePassword(parms);
  }
}
