...
class FacultyChangePasswordUsecase extends UseCase<String, LoginParams> {
  final AuthRepository repository;

  FacultyChangePasswordUsecase({required this.repository});
  @override
  Future<Either<AppErrorHandler, String>> call(LoginParams parms) async {
    return repository.facultyChangePassword(parms);
  }
}
